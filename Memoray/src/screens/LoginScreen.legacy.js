    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.introContainer}>
          <Text style={styles.introTitle}>About Memoray</Text>
          <Text style={styles.introText}>
            Memoray is an AI-powered memory assistance system designed for individuals with Alzheimer's and memory-related conditions.
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
