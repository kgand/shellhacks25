// src/components/galleries/LandmarksGallery.tsx
import React from 'react';
import { View, StyleSheet, TouchableOpacity, Image, ActivityIndicator } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import { theme } from '../../utils/theme';
import { Text } from '../../ui/overrides/base';
import { useLandmarks } from '../../hooks/useThingsIKnow';

const LandmarksGallery: React.FC = () => {
  const { data, loading, error, refetch, state } = useLandmarks();
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text size="md" color="textPrimary" style={styles.emptyTitle}>
          No landmark photos yet
        </Text>
        <Text size="sm" color="textSecondary" style={styles.emptyMessage}>
          Add some landmark photos to get started
        </Text>
      </View>
    );
  }
...
export default LandmarksGallery;
